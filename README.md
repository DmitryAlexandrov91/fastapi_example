<div align="center">
<h1> QRKot </h1>
<p><em> Первое знакомство с библиотекой FastApi</em></p>
</div>
---
▌ Описание ℹ️

Задача проекта QRKot - освоить фреймворк FastAPI. 
В результате работы было написано api-прилжожение с логикой инвестирования благотворительных проектов.
